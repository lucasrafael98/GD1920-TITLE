...
if(keyboard_check_pressed(vk_left)){
	...
	switch(selected_option){
		...
		case 0: if(points_available < 4 && global.checkpasses > 1)	{global.checkpasses--;	points_available++;}break;
		case 3: if(points_available >0 && global.eavesdropping >= 1)	{global.eavesdropping++;	points_available--;}break;
		case 2:	if(points_available < 4 && global.eavesdropping > 1)	{global.eavesdropping--;	points_available++;}break;
		case 5:	if(points_available >0 && global.readlips >= 1)		{global.readlips++;		points_available--;}break;
		case 4:	if(points_available < 4 && global.readlips > 1)		{global.readlips--;		points_available++;}break;
		case 7:	if(points_available >0 && global.glance >= 1)			{global.glance++;			points_available--;}break;
		case 6:	if(points_available < 4 && global.glance > 1)			{global.glance--;			points_available++;}break;
