...
if(alreadyGlanced){
	...
	alreadyGlanced = true;
	obj_npc_l2_2.alreadyGlanced = true;
	canInteract = true;
	text = [
	...
	dialogue = [
            ...
            createDialogMap(1,text[1],id,[-1,-1],[[skillBranch, id, 1, 3, dc_gl, 2, 4], [skillBranch, id, 1, 3, obj_npc_l2_2.dc_gl, 7, 22]]),
            createDialogMap(2,text[2],id,3,-1),
            createDialogMap(3,text[3],id,[-1],[-1]),
            createDialogMap(4,text[4],id,5,-1),
            createDialogMap(5,text[5],id,[-1,-1],[[skillBranch, id, 5, 3, dc_gl-1, 2, 6],-1]),
            ...
            createDialogMap(19,text[19],id,20,-1),
            createDialogMap(20,text[20],id,[21,-1],[-1,-1]),
            createDialogMap(21,text[21],id,-1,-1),
            createDialogMap(22,text[22],id,23,-1),
            createDialogMap(23,text[23],id,[-1,-1],[[skillBranch, id, 23, 3, obj_npc_l2_2.dc_gl-1, 7, 24],-1]),
