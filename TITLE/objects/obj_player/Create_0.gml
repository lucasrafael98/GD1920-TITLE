...
intro_dialogue2 = [
	createDialogMap(0,intro_text[0],id,1,[npc_move,obj_npc_l2_1]),
	createDialogMap(1,intro_text[1],id,2,-1),
	createDialogMap(2,intro_text[2],id,3,[npc_move,obj_npc_l2_2]),
	createDialogMap(3,intro_text[3],id,4,[npc_move,obj_npc_l2_3]),
	createDialogMap(4,intro_text[4],id,5,[npc_move,obj_npc_l2_4]),
	createDialogMap(5,intro_text[5],id,6,[npc_move,obj_npc_l2_5]),
	createDialogMap(6,intro_text[6],id,7,[npc_move,obj_npc_l2_6]),
	createDialogMap(7,intro_text[7],id,-1,[launch_skill_board]),
];
...
// MUDAR OS DIALOGOS PARA O TEXTO CORRETO!!!!!

exit_dialogue2 = [
	createDialogMap(0,exit_text2[0],id,1,-1),
	createDialogMap(1,exit_text2[1],id,[-1,-1,-1],[[endCheckNpc4],[endCheckNpc5],[endCheckNpc3]]),
	createDialogMap(2,exit_text2[2],id,5,-1),
	createDialogMap(3,exit_text2[3],id,7,-1),
	createDialogMap(4,exit_text2[4],id,8,-1),
	createDialogMap(5,exit_text2[5],id,7,-1),
	createDialogMap(6,exit_text2[6],id,8,-1),
	createDialogMap(7,exit_text2[7],id,8,-1),
	createDialogMap(8,exit_text2[8],id,9,-1),
	createDialogMap(9,exit_text2[9],id,[30,1],[-1,-1]),
	createDialogMap(10,exit_text2[10],id,13,-1),
	createDialogMap(11,exit_text2[11],id,15,-1),
	createDialogMap(12,exit_text2[12],id,16,-1),
	createDialogMap(13,exit_text2[13],id,15,-1),
	createDialogMap(14,exit_text2[14],id,16,-1),
	createDialogMap(15,exit_text2[15],id,16,-1),
	createDialogMap(16,exit_text2[16],id,17,-1),
	createDialogMap(17,exit_text2[17],id,[26,1],[-1,-1]),
	createDialogMap(18,exit_text2[18],id,21,-1),
	createDialogMap(19,exit_text2[19],id,23,-1),
	createDialogMap(20,exit_text2[20],id,24,-1),
	createDialogMap(21,exit_text2[21],id,23,-1),
	createDialogMap(22,exit_text2[22],id,24,-1),
	createDialogMap(23,exit_text2[23],id,24,-1),
	createDialogMap(24,exit_text2[24],id,25,-1),
	createDialogMap(25,exit_text2[25],id,[32,1],[-1,-1]),
	createDialogMap(26,exit_text2[26],id,27,[goodEndMusic]),
	createDialogMap(27,exit_text2[27],id,28,-1),
	createDialogMap(28,exit_text2[28],id,29,-1),
	createDialogMap(29,exit_text2[29],id,-1,-1),
	createDialogMap(30,exit_text2[30],id,31,[badEndMusic]),
	createDialogMap(31,exit_text2[31],id,-1,-1),
	createDialogMap(32,exit_text2[32],id,33,[badEndMusic]),
	createDialogMap(33,exit_text2[33],id,-1,-1),
];
