...
if(argument[0] == 8){
	if(obj_npc_l2_5.arrest_success and obj_npc_l2_5.eavesd_success){
		temp_next_line[8] = [9,-1,-1,-1,-1,-1];
	} else if(!obj_npc_l2_5.arrest_success and obj_npc_l2_5.eavesd_success){
	...
	if(obj_npc_l2_5.arrest_success and obj_npc_l2_5.eavesd_success){
		temp_next_line[41] = [42,-1,-1,-1,-1,-1];
	} else if(!obj_npc_l2_5.arrest_success and obj_npc_l2_5.eavesd_success){
