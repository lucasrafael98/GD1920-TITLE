...
dialog_add_branch(DIALOG_NPC2_1, 0, DO_NOTHING, "[check his pass]");
...
dialog_add_branch(DIALOG_NPC2_2, 0, refuse_npc2_2, "Look, I can’t get you in like this. Get cleaner and we’ll talk. Sorry.");
dialog_add_branch(DIALOG_NPC2_2, 1, refuse_npc2_2, "Get the hell out of here, right now.");
